...
import net.aircommunity.Codes;
import net.aircommunity.Configuration;
import net.aircommunity.Constants;
import net.aircommunity.common.base.Randoms;
import net.aircommunity.common.base.Strings;
import net.aircommunity.common.base.UUIDs;
import net.aircommunity.common.crypto.password.PasswordEncoder;
...
import net.aircommunity.repository.AccountAuthRepository;
import net.aircommunity.repository.AccountRepository;
...
import net.aircommunity.service.MailService;
import net.aircommunity.service.VerificationService;
