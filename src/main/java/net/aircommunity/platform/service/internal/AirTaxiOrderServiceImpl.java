...
public class AirTaxiOrderServiceImpl extends AbstractServiceSupport implements AirTaxiOrderService {
    ...
    @Override
    public Page<AirTaxiOrder> listUserAirTaxiOrders(String userId, Status status, int page,
                                                    int pageSize) {
        if (status == null) {
    ...
    @Override
    public Page<AirTaxiOrder> listTenantAirTaxiOrders(String tenantId, Status status, int page,
                                                      int pageSize) {
        if (status == null) {
    ...
    public Page<AirTaxiOrder> listAirTaxiOrders(Status status, int page, int pageSize) {
        if (status == null) {
            return Pages.adapt(airTaxiOrderRepository
